...
LIBRARY = sciFLT_gateway_c
# ------------------------------------------------------
# list of files
FILES_SRC = flsencode6.c inter_sciFLT.c sciFLT_gateway_c.cpp
# ------------------------------------------------------
# list of objects file
OBJS = flsencode6.obj inter_sciFLT.obj sciFLT_gateway_c.obj
OBJS_WITH_PATH = Release/flsencode6.obj Release/inter_sciFLT.obj Release/sciFLT_gateway_c.obj
# ------------------------------------------------------
# added libraries
FORTRAN_RUNTIME_LIBRARIES = 
OTHERLIBS = ../../src/c_xcos/libsciFLT_c_xcos.lib ../../src/c_scilab/libsciFLT_c_scilab.lib
# ------------------------------------------------------
!include $(SCIDIR)\modules\dynamic_link\src\scripts\Makefile.incl.mak
# ------------------------------------------------------
#CC = 
# ------------------------------------------------------
CFLAGS = $(CC_OPTIONS) -D__SCILAB_TOOLBOX__ -DFORDLL  -DNDEBUG -DSCIFLT_GATEWAY_C_GW_EXPORTS  
# ------------------------------------------------------
